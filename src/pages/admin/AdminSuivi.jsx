      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <form onSubmit={handleSearchSubmit} className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2.5 admin-card border border-black/[0.12] rounded-lg text-sm text-[#0a0a0a] placeholder-[#555] focus:border-[#D7A12B] focus:outline-none"
          />
        </form>
        <select
          value={actorType}
          onChange={(e) => setActorType(e.target.value)}
          className="px-3 py-2.5 admin-card border border-black/[0.12] rounded-lg text-sm text-[#0a0a0a] focus:border-[#D7A12B] focus:outline-none"
        >
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
                  ...
                  <time
                    ...
                    className="text-xs text-neutral-500 whitespace-nowrap sm:text-right shrink-0 font-mono"
                  >
